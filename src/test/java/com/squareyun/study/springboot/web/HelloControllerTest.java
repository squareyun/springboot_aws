...
import com.squareyun.study.springboot.config.auth.SecurityConfig;
...
@WebMvcTest(controllers = HelloController.class, excludeFilters = {@ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, classes = SecurityConfig.class)}) // 여러 스프링 테스트 어노테이션 중 Web에 집중할 수 있는 어노테이션
